...
INSERT INTO `herbal_list` VALUES (9, 5, 1, 'ขมิ้นชัน1', 'ยาสมุนไพรช่วยแก้อาการปวดและป้องกันอาการปวดข้ออักเสบ', 1);
...
INSERT INTO `lot_list` VALUES (4, 'ล็อต พิเศษ วันที่ 22', 0);
...
-- Records of officers
-- ----------------------------
INSERT INTO `officers` VALUES (1, 'admin@admin.admin', '64c92c5c3ba68347283cc112ebc49220', 1, 'ผู้ดูแลระบบเว็บไซต์', 'ผู้ดูแลระบบเว็บไซต์', '944ccdb56de3b804fa8aaf36029f2194', '2021-05-24 18:50:57', 1);
...
INSERT INTO `partner_list` VALUES (3, 'ไม่ทราบชื่อ', 0);
...
INSERT INTO `type_herbal` VALUES (4, 'เพิ่มประเภทยา', 0);
...
-- ----------------------------
INSERT INTO `web_settings` VALUES (1, 'ชื่อเว็บไซต์', 100, 1500);
