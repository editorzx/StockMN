		 <?php 
			...
			{
				$result_list = $functions->getStatusList_info($_REQUEST['id']);
		 ?>
		  <!--MODAL DIALOG-->
		  <form action="index?p=sell-status-info" method="post">
			  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				  <div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
					  <div class="modal-header">
						<h4 class="modal-title">แก้ไขสถานะการขาย</h4>
			...
			<div class="modal-content">
			  ...
			  <div class="modal-body">
					<div class="form-group col-sm-12">
						<div class="row">
							<div class="col-md-6">
								<span class="help-block">ชื่อสถานะ</span>
								<input class="form-control" id="Name" name="Name" type="text" placeholder="ชื่อสถานะ" required>
							</div>
						</div>
					</div>
			  </div>
