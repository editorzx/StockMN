...
<!-- /.modal-->
<div class="modal fade" id="report_importinstock" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-dialog-scrollable">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<div class="row content-center">
					<div class="col-md-auto">
						<div class="form-group">
							<h3 class="text-danger">กรุณาเลือกวันที่ ที่ต้องการตรวจสอบในรายงานด้านล่าง</h3>
							<input class="form-control" type="text" name="import_range" id="dateranges" />
						</div>
					</div>
				</div>
			</div>
