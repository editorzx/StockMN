          ...
          <div class="container-fluid">
            ...
            <div class="fade-in">
              <div class="row">
						  ...
						  <div class="row">
							<div class="form-group col-sm-6">
								<select class="form-control" name="items" id="items" required>
									<?php
										$result_getherballist = $functions->getHerbalImprove();
						   ...
						   <div class="row">
								<div class="form-group col-sm-12">
									<button class="form-control bg-dark text-white" type="button" id="add_export_herbal">เพิ่ม</button>
								</div>
						   </div>
						</div>
					  </div>
					...
					<div class="col-lg-12">
						<table class="table table-responsive-sm table-hover table-outline mb-0" id="bodyforaddherbal">
					...
					<div class="col-lg-12" style="margin-top:20px;margin-bottom:30px;">
						<div class="card">
							<div class="card-body">
							  <div class="row">
									<div class="form-group col-sm-12">
										<button class="form-control bg-dark text-white" type="button" id="export_herbal">บันทึกลงฐานข้อมูล</button>
									</div>
								</div>
							</div>
						</div>
