					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<i class="fa fa-align-justify"></i> รายการนำเข้ายาสมุนไพร
							...
							<div class="card-body">
								...
								<table class="table table-responsive-sm table-bordered table-striped table-sm">
									...
									<tbody>
										<?php
										$result_list = $functions->getImportHerbalData($currentPage, $perPage);
										...
										<tr class="text-center">
											...
											<td>
												<span class="badge badge-success" id="viewResultLogHerbal" data-id="<?php echo $row['Id'] ?>">ดูรายละเอียด</span>
											</td>
										</tr>
										<?php
										}
