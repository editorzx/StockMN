/*
 ...
 Source Server         : herb.pho.in.th_3306
 Source Server Type    : MariaDB
 Source Server Version : 100328
 Source Host           : herb.pho.in.th:3306
 Source Schema         : herb
...
CREATE TABLE `exported_medical_data`  (
  ...
  `out_date` datetime(0) NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `id_officers`(`id_officers`) USING BTREE,
...
CREATE TABLE `imported_herbal_info`  (
  ...
  `price` decimal(10, 2) UNSIGNED NOT NULL,
  `quantity` int(11) NOT NULL,
  `expire_date` datetime(0) NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `imported_medical_data`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_officer` int(11) NOT NULL,
  `import_date` datetime(0) NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `id_officer`(`id_officer`) USING BTREE,
...
CREATE TABLE `officers`  (
  ...
  `Last_Login` datetime(0) NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of officers
-- ----------------------------
INSERT INTO `officers` VALUES (1, 'admin@admin.admin', '64c92c5c3ba68347283cc112ebc49220', 1, 'ผู้ดูแลระบบเว็บไซต์', 'ผู้ดูแลระบบเว็บไซต์', 'de16f92e2757499594f56c84fca8ceca', '2021-07-05 13:24:38', 1);
...
CREATE TABLE `transaction_log_herbal`  (
  ...
  `date` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
